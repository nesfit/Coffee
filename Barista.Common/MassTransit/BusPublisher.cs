...
namespace Barista.Common.MassTransit
{
    public class BusPublisher : IBusPublisher
    {
        ...
        protected async Task<TResult> ActuallySendRequest<TCommand, TResult>(TCommand command) where TCommand : class, ICommand where TResult : class, IOperationResult
        {
            ...
            var client = _bus.CreateRequestClient<TCommand>(serviceAddress, TimeSpan.FromSeconds(30));
        ...
        public async Task Publish<TEvent>(TEvent @event) where TEvent : IEvent
        {
            ...
            string routingKey;
            const string usualCommandsNamespace = "Barista.Contracts.Events.";
            if (!commandType.IsInterface)
            ...
            if (commandType.FullName.StartsWith(usualCommandsNamespace))
                ...
                throw new BaristaException("unknown_message_namespace", $"The event '{commandType.FullName}' is not assigned to any message namespace");
