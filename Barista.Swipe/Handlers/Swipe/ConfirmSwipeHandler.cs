...
{
    public class ConfirmSwipeHandler : ICommandHandler<IConfirmSwipe, IOperationResult>
    {
        private readonly IBusPublisher _busPublisher;
        private readonly IAccountingService _accountingService;

        public ConfirmSwipeHandler(IBusPublisher busPublisher, IAccountingService accountingService)
        {
