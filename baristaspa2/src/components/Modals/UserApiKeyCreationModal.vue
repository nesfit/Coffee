<template>
    <b-modal size="md" v-if="userId" ref="modal" title="Create New API Key" ok="Create" @hidden="onCancel" @close="onCancel" @cancel="onCancel" v-bind:ok-disabled="!keyCreated && (isCreating || !label)" @ok="onSubmit">
...
export default {
    ...
    methods: {
        ...
        onSubmit: function(evt) {
            ...
            c.$api.post("users/"+this.userId+"/apiKeys", formData)
                .then(resp => {
