...
{
    [TestClass]
    public class CreateSaleBasedStockOperationHandlerTests
    {
        ...
        private readonly Mock<ICreateSaleBasedStockOperation> _command;
        private ICreateSaleBasedStockOperation Cmd => _command.Object;

        public CreateSaleBasedStockOperationHandlerTests()
        {
            _command = new Mock<ICreateSaleBasedStockOperation>();
        ...
        public void AddsStockOperationToRepository_RaisesIntegrationEvent()
        {
            ...
            repository.Setup(r => r.AddAsync(It.Is<Domain.SaleBasedStockOperation>(p => ValidateEquality(p)))).Returns(Task.CompletedTask).Verifiable();
            repository.Setup(r => r.SaveChanges()).Returns(Task.CompletedTask).Verifiable();

            var busPublisher = new Mock<IBusPublisher>(MockBehavior.Strict);
            busPublisher.Setup(p => p.Publish<ISaleBasedStockOperationCreated>(It.Is<ISaleBasedStockOperationCreated>(e => ValidateEquality(e)))).Returns(Task.CompletedTask).Verifiable();
            ...
            var handler = new CreateSaleBasedStockOperationHandler(repository.Object, busPublisher.Object, siVerifier.Object, saleVerifier.Object);
