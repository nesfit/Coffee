...
{
    public class PointOfSaleCreated : IPointOfSaleCreated
    {
        public PointOfSaleCreated(Guid id, string displayName, Guid parentAccountingGroupId, Guid? saleStrategyId)
        {
            Id = id;
