...
{
    public class AssignmentToPointOfSaleUpdated : IAssignmentToPointOfSaleUpdated
    {
        public AssignmentToPointOfSaleUpdated(Guid id, Guid ofMeans, DateTimeOffset validSince, DateTimeOffset? validUntil, Guid assignedToPointOfSaleId)
        {
            Id = id;
            MeansId = ofMeans;
