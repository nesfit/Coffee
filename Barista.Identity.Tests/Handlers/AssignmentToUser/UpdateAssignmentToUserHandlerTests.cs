...
{
    [TestClass]
    public class UpdateAssignmentToUserHandlerTests
    {
        ...
        private const bool IsShared = true;

        private readonly Mock<IUpdateAssignmentToUser> _command;
        private IUpdateAssignmentToUser Cmd => _command.Object;

        public UpdateAssignmentToUserHandlerTests()
        {
            _command = new Mock<IUpdateAssignmentToUser>();
