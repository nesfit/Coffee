...
{
    [TestClass]
    public class UpdateSpendingLimitHandlerTests
    {
        ...
        private readonly Mock<IUpdateSpendingLimit> _command;
        private IUpdateSpendingLimit Cmd => _command.Object;

        public UpdateSpendingLimitHandlerTests()
        {
            _command = new Mock<IUpdateSpendingLimit>();
        ...
        private bool ValidateEquality(ISpendingLimitUpdated @event)
        {
        ...
        public void UpdatesSpendingLimitInRepository_RaisesIntegrationEvent()
        {
            ...
            busPublisher.Setup(p => p.Publish<ISpendingLimitUpdated>(It.Is<ISpendingLimitUpdated>(e => ValidateEquality(e)))).Returns(Task.CompletedTask).Verifiable();

            var handler = new UpdateSpendingLimitHandler(repository.Object, busPublisher.Object);
